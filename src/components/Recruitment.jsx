  ...
  const recruitments = [
    {
      ...
      formUrl:
        "https://docs.google.com/forms/d/e/1FAIpQLSeCqeluhY2xJ18LewaZGBEw-nHkfD6ISr-ZPqiiJQuc9cy_Ig/viewform",
      requirements: [
        "Mechanics/Electronics knowledge",
        "Familiarity with CAD/Simulation is a plus",
    ...
    },
    {
      ...
      formUrl:
        "https://docs.google.com/forms/d/e/1FAIpQLSc9hmUE8Y4EIj9XbZubX1_08fgK19zvBf9Di1gNxC9hLGgvJA/viewform?usp=header",
      requirements: [
        "Excellent pitching & communication skills",
        "Basic financial knowledge",
        "Creative writing & management interest",
      ],
    ...
    },
    {
      ...
      requirements: [
        "Proficiency in Adobe Suite/Figma/Canva",
        "Video editing & camera handling skills",
        "Social media management interest",
      ],
    ...
    <section id="recruitments" className="recruitment-section">
      ...
      <div className="container">
        ...
        <p className="recruitment-intro">
          Are you ready to accelerate your engineering career? We recruit once a
          year, looking for dedicated, hard-working students of NITK who are
          passionate about motorsport and hands-on work.
        </p>
